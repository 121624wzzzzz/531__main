...
if __name__ == "__main__":
    ...
    parser.add_argument('--tie_word_embeddings', default=1, type=int, choices=[0, 1], help="是否绑定embed_tokens与lm_head（0=untied，需与base保持一致）")
    ...
    lm_config = MiniMindConfig(hidden_size=args.hidden_size, num_hidden_layers=args.num_hidden_layers, use_moe=bool(args.use_moe), tie_word_embeddings=bool(args.tie_word_embeddings))
